# Contributing to Dartface

Thanks for helping improve Dartface. Bug reports, focused fixes, documentation improvements, and well-scoped features are welcome.
...
- Search [existing issues](https://github.com/focale-editor/dartface/issues) before opening a new one.
...
Dartface follows the SDK constraint in [`pubspec.yaml`](pubspec.yaml). Install a compatible stable Flutter SDK, fork the repository, and run:

```sh
git clone https://github.com/YOUR_ACCOUNT/dartface.git
cd dartface
flutter pub get
```
